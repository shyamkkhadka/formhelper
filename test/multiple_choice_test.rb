...
class MultipleChoiceTest < Test::Unit::TestCase
  def test_should_create_multiple_choice_answer_field 
    ...
    assert_raise(FormHelper::ParameterExpectedException){ FormHelper::MultipleChoice.new(:id => "fav-color", :label => "Choose your favourite color") }

    mc = FormHelper::MultipleChoice.new(:id => "fav-color", :label => "Choose your favourite color",
  ...
  def test_should_support_different_field_types
    ...
    assert_raise(ArgumentError){ FormHelper::MultipleChoice.new(:id => "fav-color", :label => "Choose your favourite color",
                                                                  :values => ["Red color","Green color"],
                                                                  :field_type => "list"
                                                                ) 
                                }
